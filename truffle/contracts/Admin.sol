...
contract Admin is Library{
    ...
    function addItem( MediaType _mediaType, Category _category, string memory _title, uint _itemNumber, string memory _publish, uint _edition,  uint _year, string memory _seriesName, string[] memory _tags, uint _copies, bool _isAvailable) public onlyAdmin {
    ...
    function editItem( uint _ID, Category _category, string memory _seriesName, string[] memory _tags, uint _copies, bool _isAvailable) public onlyAdmin{
    ...
    function showListOfMemebersFromBarrowedITem(uint _itemID)public view onlyAdmin returns(address[] memory){
